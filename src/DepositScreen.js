...
const DATA = [
    ...
    {
        id: '58693a0f-3de1-471f-bd96-145573459d72',
        title: 'AVAX',
        description: '28,864.20',
        image: 'https://miro.medium.com/max/1000/1*RK1R9BV_5-_2yXLWjuP-qw.png',
        to: 'to: 2egrr3',
        from: 'from: e9okmgl',
        add: '37.51',
        ...
        <ApplicationProvider {...eva} theme={eva.light}>
            <Layout style={{flex: 1, alignItems: 'center'}}>
                <View style={{flexDirection: 'row'}}>
                    ...
                    <Text category='s1' style={{fontSize: 18, top: 65}}>Deposits</Text>
                    <View style={{left: 100, top: 65, marginLeft: 'auto'}}>
                        <TouchableOpacity onPress={() => {
                            navigation.navigate("SearchForDeposit")
                        }}>
                            <Ionicons
                                name="search-outline"
                                color='#000'
                        ...
                        return <View style={[styles.latestItem]}>
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <View style={{flexDirection: 'column', top: 5, left: 5}}>
                                    ...
                                    <View style={{flexDirection: 'row'}}>
                                    <Text style={styles.description}>{item.add}</Text>
                                    {item.col === 'add' ?
                                        <View style={{width: 80, height: 20, backgroundColor: '#EFFFF9', borderRadius: 20, right: 0, alignItems: 'center', left: 2, top: -3, justifyContent: 'flex-start'}}>
                                            <Text style={styles.description4}>{item.min}</Text>
                                        </View>
                                        :
                                        <View style={{width: 60, height: 20, backgroundColor: '#FCF1F1', borderRadius: 20, right: 0, alignItems: 'center', left: 2, top: -3}}>
                                ...
                                <View style={{flexDirection: 'column', alignItems: 'flex-end', right: -90 }}>
                                    ...
                                    <Text style={styles.description3}>{item.from}</Text>
                                </View>
                            </View>
                        </View>
                    }}
